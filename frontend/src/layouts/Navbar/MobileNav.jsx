...
function MobileNav({user, logout}) {
  ...
  return (
    <>
        <div className='relative mt-1 lg:hidden' ref={ref}>
            ...
            {
                open && (
                    <div className='w-[265px] h-[265px] backdrop-blur-md bg-black/40 absolute top-[40px] right-[-10%] z-10 rounded-[4px] p-[20px]'>
                        <ul className='text-white'>
                            {/* manage account */}
                            <li>
                                <a href="/account/profile" className='flex items-center gap-[16px] p-[10px] text-[0.875rem]'>
