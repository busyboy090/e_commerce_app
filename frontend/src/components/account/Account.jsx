  ...
  const sidebarSections = [
    {
      ...
      links: [
        { label: 'My Profile', href: '/account/manage-account/profile', isActive: URL.includes('profile') },
        { label: 'Address Book', href: '/account/manage-account/address-book', isActive: URL.includes('address-book') },
        { label: 'My Payment Options', href: '/account/manage-account/payment-option', isActive: URL.includes('payment-option') },
      ],
    },
    {
      title: 'My Orders',
