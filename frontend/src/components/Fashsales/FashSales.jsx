  ...
  return (
    <div className='container'>
        <div className='mt-[90px] mb-[50px] pb-[50px] border-b-1 border-[#E0E0E0]'>
                    ...
                    <Countdown
                        ...
                        <div>
                            <div className='title flex gap-[10px] items-center'>
                                <div className=''>
                                    <span className='block text-[0.75rem] font-semibold'>Days</span>
                                ...
                                <div>
                                    <span className='block text-[0.75rem] font-semibold'>Hours</span>
                                    <span className='text-[2rem] font-bold'>
                                        {formatNumber(hours)}
                                    </span>
                                </div>
                                <span className='text-[#E07575] text-[25px]'>:</span>
                                <div>
                                    <span className='block text-[0.75rem] font-semibold'>Minutes</span>
                                    <span className='text-[2rem] font-bold'>
                                ...
                                <span className='text-[#E07575] text-[25px]'>:</span>
                                <div>
                                    <span className='block text-[0.75rem] font-semibold'>Seconds</span>
                                    <span className='text-[2rem] font-bold'>
            ...
            <a href="/product" className='bg-[#DB4444] text-white w-[234px] h-[56px] flex justify-center items-center rounded-[4px] mx-auto'>
                View All Products
            </a>
        </div>
    </div>
